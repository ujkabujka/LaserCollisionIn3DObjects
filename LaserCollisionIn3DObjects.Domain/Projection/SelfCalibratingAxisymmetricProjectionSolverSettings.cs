...
public sealed class SelfCalibratingAxisymmetricProjectionSolverSettings
{
    public static SelfCalibratingAxisymmetricProjectionSolverSettings Default { get; } = new();
